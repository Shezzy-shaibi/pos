...
class Customer(Model):
    ...
    customer_type = models.ForeignKey(CustomerType, db_column='customer_type', verbose_name='Kategori', on_delete=models.CASCADE)
    ...
    refferer = models.ForeignKey('self', null=True, on_delete=models.CASCADE)
