...
from advancepos.models import Customer, Store, Patient, Treatment, StoreSettings
from advancepos.forms import CustomerForm, PatientForm, TreatmentForm, StoreSettingsForm
...
#         model=Order,
#         post_save_redirect=reverse('advancepos.views.list_customers'),
