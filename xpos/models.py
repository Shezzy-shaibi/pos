...
from advancepos.helpers import get_customertype_for_choices
from advancepos.models import CustomerType

from advancepos.models import Customer
...
class Order(Model):
    ...
    store = models.ForeignKey('jazzpos.Store', on_delete=models.CASCADE)
...
class ItemPrice(Model):
    item = models.ForeignKey('xpos.Item', on_delete=models.CASCADE) # has to avoid cyclic import
